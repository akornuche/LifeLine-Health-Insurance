      ...
      <section class="dashboard">
        ...
        <div class="stats-grid">
          <div class="stat-card">
            ...
            <div class="details">
              ...
              <div class="label">Prescription Orders</div>
            </div>
          </div>
        ...
        <div class="panels">
          <section class="panel">
            ...
            <ul>
              <li><strong>Amoxicillin</strong> - John Doe</li>
              <li><strong>Paracetamol</strong> - Jane Smith</li>
            </ul>
          ...
          <section class="panel">
            ...
            <ul>
              <li><strong>Insulin</strong> - 3 units left</li>
              <li><strong>Cough Syrup</strong> - 5 units left</li>
            </ul>
            <button class="btn-more">Manage Inventory</button>
          </section>
        </div>
      </section>
    </main>
...
onMounted(() => {
  ...
  if (stored) {
    ...
    profileImage.value = user.value.photoUrl || 'https://randomuser.me/api/portraits/men/20.jpg';
